...
public class VendorsFragment extends Fragment {
    ...
    @Bind(R.id.list_vendors)
    RecyclerView listVendors;
    @Bind(R.id.fab)
    FloatingActionButton floatingActionButton;
    private LinearLayoutManager mLinearLayoutManager;
    public static final String TAG = "VendorsFragment";
    public static VendorsAdapter vendorsAdapter;

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.vendors_fragment, container, false);
        return v;
    }

    public void init(){
        vendorsAdapter = new VendorsAdapter(Vendors.getVendors(), getActivity());
        mLinearLayoutManager = new LinearLayoutManager(ApplicationContext.get());
        listVendors.setAdapter(vendorsAdapter);
        listVendors.setLayoutManager(mLinearLayoutManager);
        listVendors.setItemAnimator(new DefaultItemAnimator());
        setSearchCustomers();
    }
    ...
    public void setSearchCustomers(){
        searchEditText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                vendorsAdapter.clearItems();
                for(Vendors vendors : Vendors.getSearchVendors(searchString)){
                    vendorsAdapter.addItem(vendors);
                }
            }
        });
    }
    ...
    void addNewAccount(){
        ...
        MainActivity.replaceFragment(addVendorFragment, TAG);
    }
