...
public class AddEmployeeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.create_employee_fragment, container, false);
        return v;
    }
    ...
    public void updateProfile() {
        if (isNetworkAvailable()) {
            ...
            Observable<EmployeeResponseWrapper> observable = cloudCheetahAPIService.createEmployee(firstNameET.getText().toString(),
                    ...
                    .subscribe(new Subscriber<EmployeeResponseWrapper>() {
                        ...
                        public void onNext(EmployeeResponseWrapper employeeResponseWrapper) {
                            if (employeeResponseWrapper.getResponse().getStatus_code() == AccountGeneral.SUCCESS_CODE) {
                                ...
                                Toast.makeText(getActivity(), "There is a adding the employee please try again later.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        } else {
            Toast.makeText(getActivity(), "Please connect to a network to add new employee.", Toast.LENGTH_SHORT).show();
        }
